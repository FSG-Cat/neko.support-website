...
More custodial moderation is going to be needed by a lot of these communities to deal with these new users. Because the ones who are here and want to integrate will need help and they are worth it if we want to grow. The problem is how hard it is going to be to filter out all the chaff from the quality users. Especially in an age of machines deluded into "thinking" and rising levels of polarization.
